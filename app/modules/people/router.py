...
async def list_people(
    search: Optional[str] = Query(None, description="Buscar personagem por nome", examples="luke"),
...
async def get_person(person_id: int = Path(..., ge=1, description="ID do personagem", examples=1)):
    """
